...
// function should take in an artist name and an album title, and it should return a Object containing these 
...
// optional parameter to make_album() that allows you to store the number of tracks on an album. If the 
